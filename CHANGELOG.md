...
## [0.2.11](https://github.com/spacesprotocol/certrelay/compare/fabric-v0.2.10...fabric-v0.2.11)
 - 2026-09-21

### Chore

- *(deps)* Bump spaces crates to 0.5.0, libveritas to 0.4.5

## [0.2.10](https://github.com/spacesprotocol/certrelay/compare/fabric-v0.2.9...fabric-v0.2.10)
 - 2026-09-15

### Chore

- *(deps)* Bump spaces crates to 0.4.2, libveritas to 0.4.4
