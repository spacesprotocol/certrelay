...
use crate::ChainProofAnswer;

pub struct SpacedClient {
    client: HttpClient,
    #[cfg(test)]
    mock_chain_proof: Option<ChainProofAnswer>,
}
...
impl SpacedClient {
    ...
    #[cfg(test)]
    pub fn mock(chain_proof: ChainProofAnswer) -> Self {
    ...
    pub async fn prove(&self, req: &ChainProofRequest) -> anyhow::Result<ChainProofAnswer> {
        #[cfg(test)]
